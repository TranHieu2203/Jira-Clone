...
public sealed class AuditLogDbContextFactory : IDesignTimeDbContextFactory<AuditLogDbContext>
{
    public AuditLogDbContext CreateDbContext(string[] args)
    {
        ...
        DbContextOptionsBuilder<AuditLogDbContext> builder = new();
        builder.UseConfiguredDatabase(cfg, migrationsAssembly: typeof(AuditLogDbContextFactory).Assembly.GetName().Name);
