...
public sealed class ActivityLogDbContextFactory : IDesignTimeDbContextFactory<ActivityLogDbContext>
{
    public ActivityLogDbContext CreateDbContext(string[] args)
    {
        ...
        DbContextOptionsBuilder<ActivityLogDbContext> builder = new();
        builder.UseConfiguredDatabase(cfg, migrationsAssembly: typeof(ActivityLogDbContextFactory).Assembly.GetName().Name);
